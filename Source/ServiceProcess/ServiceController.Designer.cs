...
namespace GortServiceDebugger
{
   partial class ServicesController
   {
      ...
      private void InitializeComponent()
      {
			...
			this.lvServices.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("lvServices.BackgroundImage")));
			...
			this.label1.Text = "Copyright ©2006-2020 Gort Technology";
			// 
			// ServicesController
			// 
